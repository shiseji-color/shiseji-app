...
export const handler = async (event, context) => {
    ...
    if (!API_KEY || !BASE_URL) {
        return { statusCode: 500, body: JSON.stringify({ error: '💔 大脑缺电：环境变量未配置！' }) };
    }
    ...
    try {
        ...
        try {
            ...
            return { statusCode: 500, body: JSON.stringify({ error: '💔 大脑瓦解，请再测一次！' }) };
        }
        ...
        return { statusCode: 500, body: JSON.stringify({ error: '💔 大脑罢工，请稍后再试！' }) };
    }
};
